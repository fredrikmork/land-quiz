          ...
          {continents.map((continent) => {
            ...
            return (
              <Link
                ...
                style={
                  { "--glow-color": continent.glowColor } as React.CSSProperties
                }
              >
                <div
                  className="continent-card-bg"
                  style={{ background: continent.gradient }}
                />
                <div className="continent-card-content">
                  <div className="continent-icon">
                    {continent.name === "Oseania" && (
                      <div className="continent-decorative-image">
                        <img src="/oseania-white.svg" alt="" />
                      </div>
                    )}
                    {continent.name === "Europa" && (
                      <div className="continent-decorative-image">
                        <img src="/europa-white.svg" alt="" />
                      </div>
                    )}
                    {continent.name === "Asia" && (
                      <div className="continent-decorative-image">
                        <img src="/asia-white.svg" alt="" />
                      </div>
                    )}
                    {continent.name === "Afrika" && (
                      <div className="continent-decorative-image">
                        <img src="/africa-white.svg" alt="" />
                      </div>
                    )}
                    {continent.name === "Nord-Amerika" && (
                      <div className="continent-decorative-image">
                        <img src="/north-america-white.svg" alt="" />
                      </div>
                    )}
                    {continent.name === "Sør-Amerika" && (
                      <div className="continent-decorative-image">
                        <img src="/south-america-white.svg" alt="" />
                      </div>
                    )}
                  </div>
                  <div className="continent-info">
                    <span className="continent-name">{continent.name}</span>
                    <span className="challenge-count">{count} land</span>
                  </div>
                </div>
              </Link>
            );
      ...
      <section className="scope-section">
        ...
        <div className="challenge-grid">
          <Link
            ...
            style={
              { "--glow-color": "var(--glow-card-3)" } as React.CSSProperties
            }
          >
            <div
              className="challenge-card-bg"
          ...
          {isAuthenticated ? (
            <Link
              to="/quiz/practice"
              className={`challenge-card practice-card ${
                practiceCount === 0 ? "disabled" : ""
              }`}
              onClick={(e) => practiceCount === 0 && e.preventDefault()}
              style={
                { "--glow-color": "var(--glow-card-4)" } as React.CSSProperties
              }
            >
              <div
                className="challenge-card-bg"
            ...
            <div
              className="challenge-card practice-card disabled"
              style={
                { "--glow-color": "var(--glow-card-4)" } as React.CSSProperties
              }
            >
